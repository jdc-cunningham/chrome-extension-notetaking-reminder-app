...
// https://github.com/jdc-cunningham/cross-platform-app/blob/master/shared-api/api/methods/notes.js
...
const saveNote = (req, res) => {
    ...
    // there isn't a search to update, lazy "versioning"
    pool.query(
        `INSERT INTO notes SET id = ?, name = ?, body = ?, created_at = ?`,
